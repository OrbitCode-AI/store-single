...
const defaultFeatures: Feature[] = [
  {
    ...
    description: 'Experience unparalleled speed with our optimized design that delivers results in milliseconds.'
  },
  {
    icon: '🛡️',
    title: 'Built to Last',
    description: 'Premium materials and rigorous testing ensure your product withstands years of use.'
  },
  {
    icon: '🎨',
  ...
  },
  {
    ...
    description: 'Seamlessly connects with your favorite devices and apps for a unified experience.'
  },
  {
    icon: '💬',
    title: '24/7 Support',
